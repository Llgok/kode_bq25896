...
#define TAG "bq25896 Driver"
    ...
    esp_err_t bq25896_init(std::shared_ptr<Cpp_Bus_Driver::Bus_Iic_Guide> bus, bq25896_handle_t handle)
    {
        ...
        esp_err_t ret = bq25896_get_part_number(handle, &part_number);
        if (ret != ESP_OK)
        {
        ...
        ret = bq25896_get_device_revision(handle, &dev_rev);
        if (ret != ESP_OK)
        {
    ...
    *                  REGISTER 00h
    ...
    esp_err_t bq25896_set_hiz_mode(bq25896_handle_t handle, bq25896_hiz_state_t state)
    {
        ...
        handle->config.enable_hiz = (bq25896_hiz_state_t)(state == BQ25896_HIZ_ENABLE);
    ...
    esp_err_t bq25896_set_ilim_pin(bq25896_handle_t handle, bq25896_ilim_pin_state_t state)
    {
        ...
        handle->config.enable_ilim_pin = (bq25896_ilim_pin_state_t)(state == BQ25896_ILIM_PIN_ENABLE);
    ...
    *                  REGISTER 01h
    ...
    esp_err_t bq25896_set_vindpm_offset(bq25896_handle_t handle, bq25896_vindpm_os_t offset)
    {
        ...
        handle->config.vindpm_offset = (bq25896_vindpm_os_t)offset_mv;
    ...
    *                  REGISTER 02h
    ...
    esp_err_t bq25896_set_ico(bq25896_handle_t handle, bq25896_ico_state_t state)
    {
        ...
        handle->config.ico_en = (bq25896_ico_state_t)(state == BQ25896_ICO_ENABLE);
    ...
    esp_err_t bq25896_set_auto_dpdm(bq25896_handle_t handle, bq25896_auto_dpdm_state_t state)
    {
        ...
        handle->config.auto_dpdm_en = (bq25896_auto_dpdm_state_t)(state == BQ25896_AUTO_DPDM_ENABLE);
    ...
    *                  REGISTER 03h
    ...
    esp_err_t bq25896_set_bat_load(bq25896_handle_t handle, bq25896_bat_load_state_t state)
    {
        ...
        handle->config.bat_load = (bq25896_bat_load_state_t)(state == BQ25896_BAT_LOAD_ENABLE);
    ...
    esp_err_t bq25896_set_otg(bq25896_handle_t handle, bq25896_otg_state_t state)
    {
        ...
        handle->config.otg_config = (bq25896_otg_state_t)(state == BQ25896_OTG_ENABLE);
    ...
    esp_err_t bq25896_set_charging(bq25896_handle_t handle, bq25896_chg_state_t state)
    {
        ...
        handle->config.chg_config = (bq25896_chg_state_t)(state == BQ25896_CHG_ENABLE);
    ...
    esp_err_t bq25896_set_min_vbat(bq25896_handle_t handle, bq25896_min_vbat_sel_t vbat_sel)
    {
        ...
        handle->config.min_vbat_sel = (bq25896_min_vbat_sel_t)(vbat_sel == BQ25896_MIN_VBAT_2500MV);
    ...
    *                  REGISTER 04h
    ...
    esp_err_t bq25896_set_charge_current(bq25896_handle_t handle, bq25896_ichg_t ichg)
    {
        ...
        handle->config.ichg = (bq25896_ichg_t)current_ma;
    ...
    *                  REGISTER 05h
    ...
    esp_err_t bq25896_set_precharge_current(bq25896_handle_t handle, bq25896_prechg_current_t current)
    {
        ...
        handle->config.iprechg = (bq25896_prechg_current_t)actual_current;
    ...
    esp_err_t bq25896_set_termination_current(bq25896_handle_t handle, bq25896_iterm_current_t current)
    {
        ...
        handle->config.iterm = (bq25896_iterm_current_t)actual_current;
    ...
    *                  REGISTER 06h
    ...
    esp_err_t bq25896_set_charge_voltage(bq25896_handle_t handle, bq25896_vreg_t vreg)
    {
        ...
        handle->config.vreg = (bq25896_vreg_t)actual_voltage;
    ...
    *                  REGISTER 07h
    ...
    esp_err_t bq25896_set_termination_state(bq25896_handle_t handle, bq25896_term_state_t state)
    {
        ...
        handle->config.en_term = (bq25896_term_state_t)(state == BQ25896_TERM_ENABLE);
    ...
    esp_err_t bq25896_set_stat_pin_state(bq25896_handle_t handle, bq25896_stat_pin_state_t state)
    {
        ...
        handle->config.stat_dis = (bq25896_stat_pin_state_t)(state == BQ25896_STAT_ENABLE);
    ...
    esp_err_t bq25896_set_watchdog_timer(bq25896_handle_t handle, bq25896_watchdog_t watchdog)
    {
        ...
        switch (watchdog)
        {
        case BQ25896_WATCHDOG_DISABLE:
            watchdog_str = "disabled";
            break;
        case BQ25896_WATCHDOG_40S:
            watchdog_str = "40 seconds";
            break;
        case BQ25896_WATCHDOG_80S:
            watchdog_str = "80 seconds";
            break;
        case BQ25896_WATCHDOG_160S:
            watchdog_str = "160 seconds";
            break;
        default:
            watchdog_str = "unknown";
            break;
        }
    ...
    esp_err_t bq25896_set_safety_timer_state(bq25896_handle_t handle, bq25896_safety_timer_state_t state)
    {
        ...
        handle->config.en_timer = (bq25896_safety_timer_state_t)(state == BQ25896_SAFETY_TIMER_ENABLE);
    ...
    esp_err_t bq25896_set_charge_timer(bq25896_handle_t handle, bq25896_chg_timer_t timer)
    {
        ...
        switch (timer)
        {
        case BQ25896_CHG_TIMER_5H:
            timer_str = "5 hours";
            break;
        case BQ25896_CHG_TIMER_8H:
            timer_str = "8 hours";
            break;
        case BQ25896_CHG_TIMER_12H:
            timer_str = "12 hours";
            break;
        case BQ25896_CHG_TIMER_20H:
            timer_str = "20 hours";
            break;
        default:
            timer_str = "unknown";
    ...
    *                  REGISTER 08h
    ...
    esp_err_t bq25896_set_bat_comp(bq25896_handle_t handle, bq25896_bat_comp_t bat_comp)
    {
        ...
        switch (bat_comp)
        {
        case BQ25896_BAT_COMP_0MO:
            mohm_value = 0;
            break;
        case BQ25896_BAT_COMP_20MO:
            mohm_value = 20;
            break;
        case BQ25896_BAT_COMP_40MO:
            mohm_value = 40;
            break;
        case BQ25896_BAT_COMP_60MO:
            mohm_value = 60;
            break;
        case BQ25896_BAT_COMP_80MO:
            mohm_value = 80;
            break;
        case BQ25896_BAT_COMP_100MO:
            mohm_value = 100;
            break;
        case BQ25896_BAT_COMP_120MO:
            mohm_value = 120;
            break;
        case BQ25896_BAT_COMP_140MO:
            mohm_value = 140;
            break;
        }
    ...
    esp_err_t bq25896_set_vclamp(bq25896_handle_t handle, bq25896_vclamp_t vclamp)
    {
        ...
        switch (vclamp)
        {
        case BQ25896_VCLAMP_0MV:
            mv_value = 0;
            break;
        case BQ25896_VCLAMP_32MV:
            mv_value = 32;
            break;
        case BQ25896_VCLAMP_64MV:
            mv_value = 64;
            break;
        case BQ25896_VCLAMP_96MV:
            mv_value = 96;
            break;
        case BQ25896_VCLAMP_128MV:
            mv_value = 128;
            break;
        case BQ25896_VCLAMP_160MV:
            mv_value = 160;
            break;
        case BQ25896_VCLAMP_192MV:
            mv_value = 192;
            break;
        case BQ25896_VCLAMP_224MV:
            mv_value = 224;
            break;
        }
    ...
    esp_err_t bq25896_set_treg(bq25896_handle_t handle, bq25896_treg_t treg)
    {
        ...
        switch (treg)
        {
        case BQ25896_TREG_60C:
            degree_value = 60;
            break;
        case BQ25896_TREG_80C:
            degree_value = 80;
            break;
        case BQ25896_TREG_100C:
            degree_value = 100;
            break;
        case BQ25896_TREG_120C:
            degree_value = 120;
            break;
        }
    ...
    *                  REGISTER 09h
    ...
    esp_err_t bq25896_set_timer_extension(bq25896_handle_t handle, bq25896_tmr2x_t state)
    {
        ...
        handle->config.tmr2x_en = (bq25896_tmr2x_t)(state == BQ25896_TMR2X_ENABLE);
    ...
    esp_err_t bq25896_set_batfet_state(bq25896_handle_t handle, bq25896_batfet_state_t state)
    {
        ...
        handle->config.batfet_dis = (bq25896_batfet_state_t)(state == BQ25896_BATFET_DISABLE);
    ...
    *                  REGISTER 0Ah
    ...
    esp_err_t bq25896_set_boost_voltage(bq25896_handle_t handle, bq25896_boostv_t boostv)
    {
        ...
        handle->config.boostv = (bq25896_boostv_t)actual_voltage;
    ...
    esp_err_t bq25896_set_pfm_boost_mode(bq25896_handle_t handle, bq25896_pfm_boost_t pfm_state)
    {
        ...
        handle->config.pfm_otg_dis = (bq25896_pfm_boost_t)(pfm_state == BQ25896_PFM_BOOST_DISABLE);
    ...
    esp_err_t bq25896_set_boost_current_limit(bq25896_handle_t handle, bq25896_boost_lim_t boost_lim)
    {
        ...
        switch (boost_lim)
        {
        case BQ25896_BOOST_LIM_500MA:
            actual_current = 500;
            break;
        case BQ25896_BOOST_LIM_750MA:
            actual_current = 750;
            break;
        case BQ25896_BOOST_LIM_1200MA:
            actual_current = 1200;
            break;
        case BQ25896_BOOST_LIM_1400MA:
            actual_current = 1400;
            break;
        case BQ25896_BOOST_LIM_1650MA:
            actual_current = 1650;
            break;
        case BQ25896_BOOST_LIM_1875MA:
            actual_current = 1875;
            break;
        case BQ25896_BOOST_LIM_2150MA:
            actual_current = 2150;
            break;
        default:
            actual_current = 0;
        ...
        handle->config.boost_lim = (bq25896_boost_lim_t)actual_current;
    ...
    *                  REGISTER 0Bh
    ...
    esp_err_t bq25896_get_vbus_status(bq25896_handle_t handle, bq25896_vbus_stat_t *vbus_stat)
    {
        ...
        *vbus_stat = (bq25896_vbus_stat_t)((reg_val & BQ25896_REG0B_VBUS_STAT_MASK) >> BQ25896_REG0B_VBUS_STAT_SHIFT);

        // Log the status
        const char *status_str;
        switch (*vbus_stat)
        {
        case BQ25896_VBUS_STAT_NO_INPUT:
            status_str = "No Input";
            break;
        case BQ25896_VBUS_STAT_USB_HOST:
            status_str = "USB Host SDP";
            break;
        case BQ25896_VBUS_STAT_ADAPTER:
            status_str = "Adapter (3.25A)";
            break;
        case BQ25896_VBUS_STAT_OTG:
            status_str = "OTG";
            break;
        default:
            status_str = "Unknown";
    ...
    esp_err_t bq25896_get_charging_status(bq25896_handle_t handle, bq25896_chrg_stat_t *chrg_stat)
    {
        ...
        *chrg_stat = (bq25896_chrg_stat_t)((reg_val & BQ25896_REG0B_CHRG_STAT_MASK) >> BQ25896_REG0B_CHRG_STAT_SHIFT);

        // Log the status
        const char *status_str;
        switch (*chrg_stat)
        {
        case BQ25896_CHRG_STAT_NOT_CHARGING:
            status_str = "Not Charging";
            break;
        case BQ25896_CHRG_STAT_PRE_CHARGE:
            status_str = "Pre-charge";
            break;
        case BQ25896_CHRG_STAT_FAST_CHARGING:
            status_str = "Fast Charging";
            break;
        case BQ25896_CHRG_STAT_TERM_DONE:
            status_str = "Charge Termination Done";
            break;
        default:
            status_str = "Unknown";
            break;
    ...
    esp_err_t bq25896_get_pg_status(bq25896_handle_t handle, bq25896_pg_stat_t *pg_stat)
    {
        ...
        *pg_stat = (bq25896_pg_stat_t)((reg_val & BQ25896_REG0B_PG_STAT_MASK) >> BQ25896_REG0B_PG_STAT_SHIFT);
    ...
    esp_err_t bq25896_get_vsys_status(bq25896_handle_t handle, bq25896_vsys_stat_t *vsys_stat)
    {
        ...
        *vsys_stat = (bq25896_vsys_stat_t)((reg_val & BQ25896_REG0B_VSYS_STAT_MASK) >> BQ25896_REG0B_VSYS_STAT_SHIFT);

        ESP_LOGD(TAG, "VSYS Status: %s",
                 *vsys_stat == BQ25896_VSYS_STAT_IN_REG ? "In VSYSMIN regulation (BAT < VSYSMIN)" : "Not in VSYSMIN regulation (BAT > VSYSMIN)");
        return ESP_OK;
    }
    ...
    *                  REGISTER 0Ch
    ...
    esp_err_t bq25896_get_watchdog_fault(bq25896_handle_t handle, bq25896_watchdog_fault_t *fault)
    {
        ...
        *fault = (bq25896_watchdog_fault_t)((reg_val & BQ25896_REG0C_WATCHDOG_FAULT_MASK) >> BQ25896_REG0C_WATCHDOG_FAULT_SHIFT);
    ...
    esp_err_t bq25896_get_boost_fault(bq25896_handle_t handle, bq25896_boost_fault_t *fault)
    {
        ...
        *fault = (bq25896_boost_fault_t)((reg_val & BQ25896_REG0C_BOOST_FAULT_MASK) >> BQ25896_REG0C_BOOST_FAULT_SHIFT);

        ESP_LOGD(TAG, "Boost Mode Fault Status: %s",
                 *fault == BQ25896_BOOST_FAULT_NORMAL ? "Normal" : "VBUS overloaded, OVP, or battery too low");
        return ESP_OK;
    }
    ...
    esp_err_t bq25896_get_charge_fault(bq25896_handle_t handle, bq25896_chrg_fault_t *fault)
    {
        ...
        *fault = (bq25896_chrg_fault_t)((reg_val & BQ25896_REG0C_CHRG_FAULT_MASK) >> BQ25896_REG0C_CHRG_FAULT_SHIFT);

        // Log the status
        const char *status_str;
        switch (*fault)
        {
        case BQ25896_CHRG_FAULT_NORMAL:
            status_str = "Normal";
            break;
        case BQ25896_CHRG_FAULT_INPUT_FAULT:
            status_str = "Input fault";
            break;
        case BQ25896_CHRG_FAULT_THERMAL:
            status_str = "Thermal shutdown";
            break;
        case BQ25896_CHRG_FAULT_TIMER_EXPIRED:
            status_str = "Safety Timer Expiration";
            break;
        default:
            status_str = "Unknown";
            break;
    ...
    esp_err_t bq25896_get_battery_fault(bq25896_handle_t handle, bq25896_bat_fault_t *fault)
    {
        ...
        *fault = (bq25896_bat_fault_t)((reg_val & BQ25896_REG0C_BAT_FAULT_MASK) >> BQ25896_REG0C_BAT_FAULT_SHIFT);
    ...
    esp_err_t bq25896_get_ntc_fault(bq25896_handle_t handle, bq25896_ntc_fault_t *fault)
    {
        ...
        *fault = (bq25896_ntc_fault_t)((reg_val & BQ25896_REG0C_NTC_FAULT_MASK) >> BQ25896_REG0C_NTC_FAULT_SHIFT);

        // Log the status
        const char *status_str;
        switch (*fault)
        {
        case BQ25896_NTC_FAULT_NORMAL:
            status_str = "Normal";
            break;
        case BQ25896_NTC_FAULT_TS_WARM:
            status_str = "TS Warm";
            break;
        case BQ25896_NTC_FAULT_TS_COOL:
            status_str = "TS Cool";
            break;
        case BQ25896_NTC_FAULT_TS_COLD:
            status_str = "TS Cold";
            break;
        case BQ25896_NTC_FAULT_TS_HOT:
            status_str = "TS Hot";
            break;
        default:
            status_str = "Unknown";
    ...
    *                  REGISTER 0Eh
    ...
    esp_err_t bq25896_get_thermal_regulation_status(bq25896_handle_t handle, bq25896_therm_stat_t *therm_stat)
    {
        ...
        *therm_stat = (bq25896_therm_stat_t)((reg_val & BQ25896_REG0E_THERM_STAT_MASK) >> BQ25896_REG0E_THERM_STAT_SHIFT);
    ...
    *                  REGISTER 11h
    ...
    esp_err_t bq25896_get_vbus_good_status(bq25896_handle_t handle, bq25896_vbus_gd_t *vbus_gd)
    {
        ...
        *vbus_gd = (bq25896_vbus_gd_t)((reg_val & BQ25896_REG11_VBUS_GD_MASK) >> BQ25896_REG11_VBUS_GD_SHIFT);
    ...
    *                  REGISTER 13h
    ...
    esp_err_t bq25896_get_vdpm_status(bq25896_handle_t handle, bq25896_vdpm_stat_t *vdpm_stat)
    {
        ...
        *vdpm_stat = (bq25896_vdpm_stat_t)((reg_val & BQ25896_REG13_VDPM_STAT_MASK) >> BQ25896_REG13_VDPM_STAT_SHIFT);
    ...
    esp_err_t bq25896_get_idpm_status(bq25896_handle_t handle, bq25896_idpm_stat_t *idpm_stat)
    {
        ...
        *idpm_stat = (bq25896_idpm_stat_t)((reg_val & BQ25896_REG13_IDPM_STAT_MASK) >> BQ25896_REG13_IDPM_STAT_SHIFT);
    ...
    *                  REGISTER 14h
    ...
    esp_err_t bq25896_get_ico_status(bq25896_handle_t handle, bq25896_ico_status_t *ico_status)
    {
        ...
        *ico_status = (bq25896_ico_status_t)((reg_val & BQ25896_REG14_ICO_OPTIMIZED_MASK) >> BQ25896_REG14_ICO_OPTIMIZED_SHIFT);

        ESP_LOGD(TAG, "ICO Status: %s",
                 *ico_status == BQ25896_ICO_COMPLETE ? "Complete (Maximum Current Detected)" : "In Progress");
        return ESP_OK;
    }
    ...
    esp_err_t bq25896_get_device_revision(bq25896_handle_t handle, bq25896_dev_rev_t *dev_rev)
    {
        ...
        *dev_rev = (bq25896_dev_rev_t)((reg_val & BQ25896_REG14_DEV_REV_MASK) >> BQ25896_REG14_DEV_REV_SHIFT);
